		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#uxzanalytics-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uxzanalytics-display": {
								"semanticObject": "uxzanalytics",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ux.zanalytics",
									"url": sap.ui.require.toUrl("ux/zanalytics")
								}
							}
						}
					}
